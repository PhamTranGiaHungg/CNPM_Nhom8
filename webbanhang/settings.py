...
SECRET_KEY = 'django-insecure-a7(v42c5na)qh=g!29!-*(mg*vvz3%n&(@##j+e)#l^p%g$zv5'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app', 'static'),  # Đảm bảo sử dụng đúng đường dẫn đến thư mục 'static'
]
